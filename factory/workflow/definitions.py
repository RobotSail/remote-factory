...
# ── W₁₅: Deep Research Mode ──────────────────────────────────────


def deep_research_workflow() -> Workflow:
    ...
    # ── Study — understand project context before researching ──
    ...
    # ── Deep Researcher — single agent with internal iteration loop ──
    ...
    # ── Strategist — generate hypotheses from research findings ──
    ...
    # ── Archivist — record research and strategy ──
    ...
    edges = [
        # Study → deep_researcher
        Edge(source="study", target="deep_researcher"),
        # deep_researcher → gate_coverage
        Edge(source="deep_researcher", target="gate_coverage"),
        # gate_coverage → strategist (PROCEED) or back to deep_researcher (RELOOP)
...
def _get_builtin_registry() -> dict[str, Any]:
    ...
    _BUILTIN_REGISTRY = {
        ...
        "deep-research": deep_research_workflow,
